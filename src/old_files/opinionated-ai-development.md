...
I took inspiration from [this post](https://newsletter.marclou.com/p/the-tech-stack-i-use-to-make-usd-52600-month) from Marc Louvion, a prolific indie hacker, and chose Next.js, Tailwind, Vercel, and Supabase for my first project. But as I started more projects, I noticed something. AI wanted to use that exact same stack for everything \- whether it made sense or not.
