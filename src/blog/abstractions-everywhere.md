...
Your new user persona is an agent, usually named Claude. Its preferred UX isn't an interface, it's an MCP, a series of tool calls prying into the guts of your infrastructure, reporting data out and pushing it back in.
