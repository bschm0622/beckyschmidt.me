...
Compared to Gemini 2.5 Flash Lite, Gemma was a little worse out of the box. Gemini is more intuitive and needed less hand-holding, where Gemma required more explicit guidance to get to the same place. But that tradeoff was worth it. Tightening up my prompts for Gemma actually made the whole enrichment pipeline better. And being able to run it hundreds of times while iterating, without ever watching a bill, is pretty underrated.
...
For this type of focused enrichment task, yes. 100%. The cost savings are obvious, but the real surprise was how much more freely I could experiment. No bill watching means you can actually stress-test your prompts instead of being precious about it.

So far, local models are excelling at "easy" tasks like summarization and categorization. Through cheap subscriptions like Claude and ChatGPT, we're being spoiled by state-of-the-art models at dirt-cheap prices, but that tide is going to turn soon. There are already [open-source models](https://z.ai/blog/glm-5.1) at Sonnet levels of intelligence, and right now they require massive levels of compute, far beyond what a Mac Mini can do.

Either way, this was a fun experiment, and I'll keep testing local models and pushing the edges of what's possible.